...
`r countdown(minutes = 5, seconds = 0, style = "position: relative; width: min-content;")`
...
In this particular application, we would like you to produce 2 simple pieces of analysis using Kenya's 2019 census data: the share of people who are migrants in each county, and the average working hours for men and women in rural vs. urban areas. 
